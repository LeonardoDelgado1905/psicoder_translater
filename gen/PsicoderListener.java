...
public interface PsicoderListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PsicoderParser#whlie_}.
	 * @param ctx the parse tree
	 */
	void enterWhlie_(PsicoderParser.Whlie_Context ctx);
	/**
	 * Exit a parse tree produced by {@link PsicoderParser#whlie_}.
	 * @param ctx the parse tree
	 */
	void exitWhlie_(PsicoderParser.Whlie_Context ctx);
	/**
	 * Enter a parse tree produced by {@link PsicoderParser#do_whlie_}.
	 * @param ctx the parse tree
	 */
	void enterDo_whlie_(PsicoderParser.Do_whlie_Context ctx);
	/**
	 * Exit a parse tree produced by {@link PsicoderParser#do_whlie_}.
	 * @param ctx the parse tree
	 */
	void exitDo_whlie_(PsicoderParser.Do_whlie_Context ctx);
	/**
